...
li ra,0
li sp,0
beq ra,sp,<test_2+0x18>
bne zero,gp,<fail>
bne zero,gp,<test_3>
beq ra,sp,<test_2+0x14>
bne zero,gp,<fail>
li gp,3
li ra,1
li sp,1
beq ra,sp,<test_3+0x18>
bne zero,gp,<fail>
bne zero,gp,<test_4>
beq ra,sp,<test_3+0x14>
bne zero,gp,<fail>
li gp,4
li ra,-1
li sp,-1
beq ra,sp,<test_4+0x18>
bne zero,gp,<fail>
bne zero,gp,<test_5>
beq ra,sp,<test_4+0x14>
bne zero,gp,<fail>
li gp,5
li ra,0
li sp,1
beq ra,sp,<test_5+0x14>
